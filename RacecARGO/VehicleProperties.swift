...
class VehicleProperties: NSObject {
    ...
    private static let defaultProperties: [String:VehicleProperties] = [
        ...
        "vw polo":      VehicleProperties(kW: 96, weight: 1150, emission: 10, maxSpeed: 205, maxDistance: 800, numberOfClowns: 5),
        "vw golf":       VehicleProperties(kW: 55, weight: 1200, emission: 5, maxSpeed: 170, maxDistance: 650, numberOfClowns: 5),
